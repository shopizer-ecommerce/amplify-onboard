const fr_ca_lang = {
  ...
  Profile: {
    ...
    Phone: 'Téléphone',
    Picture: 'Photo',
    PictureText: 'Vous pouvez ajouter votre photo. Si vous décidez de ne pas ajouter de photo Tip&Go choisira une photo générique qui sera imprimée sur votre carte de profil.',
